...
def main():
    ...
    try:
        ...
        return ('19時すぎてるよ！')
    busy_events = que["calendars"]["iso@serverworks.co.jp"]["busy"]
    my_schedule = calc_mytime(busy_events, today_end)
    return my_schedule


def datetime2string(str_time):
...
def calc_delta(str_next_s, str_prev_e):
    int_next_s = datetime2string(str_next_s)
    int_prev_e = datetime2string(str_prev_e)
